...
<div class="home-banner">
  ...
  <div class="banner-image"><img src="@asset('images/banner-2.jpg')" alt="second banner"/></div>
</div>
<div class="home-banner-content container">
  <div class="home-cta">
    @if (has_nav_menu('home_cta_menu'))
      {!! wp_nav_menu([
        'depth' => 2, 
        'theme_location' => 'home_cta_menu', 
        'walker' => new cta_navwalker(), 
...
<div class="page-banner-content"></div>
@endif