...
if ( ! class_exists( 'CTA_Navwalker' ) ) {
  /**
   * WP_Bootstrap_Navwalker class.
   *
   * @extends Walker_Nav_Menu
   */
  class CTA_Navwalker extends Walker_Nav_Menu {
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
      ...
      if ($atts['data-toggle'] == 'dropdown')
        $item_output .= '<i class="fa fa-angle-double-down" aria-hidden="true"></i>';
      $item_output .= '</a>';
